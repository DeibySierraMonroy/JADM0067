...
/**
 * Define todos los métodos de acceso y manipulación de datos de la entidad RHU.LIBROINGRESO_DOCUMENTO
 *
...
public interface DocumentsRepo {
    ...
    /**
     * Obtiene todos los documentos de contratación asociados a un libro de ingreso que no tiene asociada una
     * referencia circular (padres)
     *
     * @param libConsecutivo ID PK de la tabla LibroIngreso
     * @return El Listado de documentos asociados al parámetro entrante
     */
    DatabaseResultDto<LibroIngresoDocumentoDto> getAllDocumentsParent(Long libConsecutivo);

    /**
     * Obtiene todos los documentos de contratación asociados a un libro de ingreso que tiene asociada una referencia
     * circular (hijos)
     *
     * @param libConsecutivo ID PK de la tabla LibroIngreso
     * @return El Listado de documentos asociados al parámetro entrante
     */
    DatabaseResultDto<LibroIngresoDocumentoDto> getAllDocumentsChild(Long libConsecutivo);
